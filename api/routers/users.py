        ...
        "profile": (
            {
                ...
                "country": user.user_profile[0].country.country if user.user_profile[0].country else None,
        ...
        "events": [
            {
                ...
                "org_unit": event.events.org_unit.name if event.events.org_unit else None,
